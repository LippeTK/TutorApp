          ...
          <div>
            <div className="d-flex justify-content-center pt-5 pb-5">
              <h1 className="display-5 pb-3">
                <strong>Curso Desenvolvimento Web Completo</strong>
              </h1>
            </div>
              ...
              <div className="row">
                ...
                <div className="col-12 col-md-6">
                  ...
                  <h5 className="pb-2 pt-2">
                    Você poderá construir páginas web de alta qualidade com as
                  ...
                  <ul className="list-group">
                    ...
                    <li className="list-group-item">
                      Como devo seguir após o término do curso?
                    </li>
                  </ul>
                  <div className="d-grid pt-4">
                    {/* style="color: #fff !important; background-color: #FF5722 !important;" */}
                    <a className="btn">Inscrever-se</a>
                  </div>
                </div>
              </div>
            </div>
